...
def main_window():
    ...
    Button(root, text="Open Analysis Window", command=analyze_runtime_window).pack(pady=10)
    Button(root, text="Open Box Plot Window", command=plot_runtime_boxplot_window).pack(pady=10)
...
def plot_runtime_boxplot_window():
    try:
        ...
        for graph_type in graph_types:
            ...
            label = tk.Label(graph_sub_frame, text=f"Box Plot - {graph_type} Graph", font=("Arial", 12, "bold"))
            label.pack()
